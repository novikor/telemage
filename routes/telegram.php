...
use App\Telegram\Commands\ReorderCommand;
...
$bot->group(function (Nutgram $bot): void {
    ...
    $bot->onCallbackQueryData('reorder {orderNumber}', ReorderCommand::class);
    $bot->onCommand('cart', CheckoutCartCommand::class)->description('View your current cart');
})
