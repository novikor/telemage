...
class Discount
{
    ...
    public protected(set) ?CartDiscountTypeEnumObject $applied_to = null;

    public protected(set) ?AppliedCoupon $coupon = null;
    ...
    public function asArray(): array
    {
        ...
        if ($this->applied_to instanceof CartDiscountTypeEnumObject) {
            $data['applied_to'] = $this->applied_to;
        }
        if ($this->coupon instanceof AppliedCoupon) {
            $data['coupon'] = $this->coupon->asArray();
        }
        if ($this->label !== null) {
