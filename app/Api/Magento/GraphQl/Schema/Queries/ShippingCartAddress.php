...
class ShippingCartAddress
{
    ...
    public protected(set) ?float $items_weight = null;

    public protected(set) ?string $lastname = null;

    public protected(set) ?string $middlename = null;

    public protected(set) ?string $pickup_location_code = null;
    ...
    public protected(set) ?bool $same_as_billing = null;
    ...
    public function asArray(): array
    {
        ...
        if ($this->items_weight !== null) {
            $data['items_weight'] = $this->items_weight;
        }
        ...
        if ($this->pickup_location_code !== null) {
            $data['pickup_location_code'] = $this->pickup_location_code;
        }
        ...
        if ($this->same_as_billing !== null) {
            $data['same_as_billing'] = $this->same_as_billing;
        }
        if ($this->selected_shipping_method instanceof SelectedShippingMethod) {
            $data['selected_shipping_method'] = $this->selected_shipping_method->asArray();
        }
        if ($this->street !== null) {
